    ...
    .print-area .text-portal-accent {
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <div>
                <span class="inline-block bg-portal-accent text-black px-2.5 py-1 rounded-md text-[0.7rem] font-extrabold uppercase tracking-wider mb-2"><?php echo e(__('DÃƒÂ©tails de la Commande')); ?></span>
                <h1 class="text-4xl font-extrabold tracking-tight mb-2">#<?php echo e($order->order_number); ?></h1>
                <p class="text-portal-muted text-lg"><?php echo e(__('PassÃƒÂ©e le')); ?> <?php echo e($order->created_at->format('d/m/Y')); ?> <?php echo e(__('ÃƒÂ ')); ?> <?php echo e($order->created_at->format('H:i')); ?></p>
            </div>
            <div class="flex items-center gap-4">
                ...
                ">
                    <?php echo e(__('Status:')); ?> <?php echo e([
                        'pending' => 'En attente',
                        'confirmed' => 'Confirmer',
                ...
                <a href="<?php echo e(route('orders.print', $order->id)); ?>" target="_blank" class="bg-white/5 border border-portal-border text-white px-4 py-3 rounded-xl font-bold hover:bg-white/10 transition-colors flex items-center gap-2 no-print">
                    <?php if (isset($component)) { $__componentOriginal854c80825c84a3841e6c3aef822f2ad5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal854c80825c84a3841e6c3aef822f2ad5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.printer','data' => ['class' => 'w-4 h-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('printer'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal854c80825c84a3841e6c3aef822f2ad5)): ?>
<?php $attributes = $__attributesOriginal854c80825c84a3841e6c3aef822f2ad5; ?>
<?php unset($__attributesOriginal854c80825c84a3841e6c3aef822f2ad5); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal854c80825c84a3841e6c3aef822f2ad5)): ?>
<?php $component = $__componentOriginal854c80825c84a3841e6c3aef822f2ad5; ?>
<?php unset($__componentOriginal854c80825c84a3841e6c3aef822f2ad5); ?>
<?php endif; ?> <?php echo e(__('Imprimer la commande')); ?>
    ...
    <div class="print-area">
        <div class="flex justify-between items-start">
            <div>
                ...
                <p class="text-sm text-gray-600">Zone Industrielle - Bordj Bou Arreridid, AlgÃƒÂ©rie</p>
                <p class="text-sm text-gray-600">TÃƒÂ©l: +213 550 00 00 00</p>
            ...
            <div class="text-right">
                ...
                <div class="text-lg font-semibold text-black">NÃ‚Â° <?php echo e($order->order_number); ?></div>
    ...
    <div class="mb-6 grid grid-cols-2 gap-8">
        ...
        <div>
            ...
            <p class="text-sm text-black"><?php echo e($order->delivery_address ?? 'Ãƒâ‚¬ dÃƒÂ©finir'); ?></p>
            <?php if($order->requested_delivery_date): ?>
            <p class="text-sm text-black">Date souhaitÃƒÂ©e: <?php echo e(\Carbon\Carbon::parse($order->requested_delivery_date)->format('d/m/Y')); ?></p>
            <?php endif; ?>
        </div>
    </div>
        ...
        <table class="w-full border-collapse">
            <thead>
                <tr class="border-b-2 border-black">
                    <th class="text-left py-2 px-4 font-bold text-black">RÃƒâ€°FÃƒâ€°RENCE</th>
                    <th class="text-left py-2 px-4 font-bold text-black">DÃƒâ€°SIGNATION</th>
                    <th class="text-center py-2 px-4 font-bold text-black">QUANTITÃƒâ€°</th>
    ...
    <div class="mt-12 pt-6 border-t-2 border-black">
        ...
        <div class="mt-8 text-center">
            <p class="text-xs text-gray-600">Document valable pour approvisionnement - Sous rÃƒÂ©serve de disponibilitÃƒÂ©</p>
            </div>
        </div>
        </div>
                            ...
                            <div class="flex flex-col items-center flex-1 relative z-10">
                                ...
                                <div class="w-12 h-12 rounded-full flex items-center justify-center mb-3 transition-all duration-300
                                    ...
                                    <?php if($index < $currentIndex): ?>
                                        <?php if (isset($component)) { $__componentOriginaldd4edf24143f8fde56ee726de74af059 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldd4edf24143f8fde56ee726de74af059 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.check','data' => ['class' => 'w-6 h-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaldd4edf24143f8fde56ee726de74af059)): ?>
<?php $attributes = $__attributesOriginaldd4edf24143f8fde56ee726de74af059; ?>
<?php unset($__attributesOriginaldd4edf24143f8fde56ee726de74af059); ?>
<?php endif; ?>
<?php if (isset($__componentOriginaldd4edf24143f8fde56ee726de74af059)): ?>
<?php $component = $__componentOriginaldd4edf24143f8fde56ee726de74af059; ?>
<?php unset($__componentOriginaldd4edf24143f8fde56ee726de74af059); ?>
<?php endif; ?>
                                    <?php elseif($index === $currentIndex): ?>
                                        <?php if (isset($component)) { $__componentOriginalbf6b7317a6165a6631bbc5afb7918d70 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbf6b7317a6165a6631bbc5afb7918d70 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.loader-2','data' => ['class' => 'w-6 h-6 animate-spin']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('loader-2'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbf6b7317a6165a6631bbc5afb7918d70)): ?>
<?php $attributes = $__attributesOriginalbf6b7317a6165a6631bbc5afb7918d70; ?>
<?php unset($__attributesOriginalbf6b7317a6165a6631bbc5afb7918d70); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalbf6b7317a6165a6631bbc5afb7918d70)): ?>
<?php $component = $__componentOriginalbf6b7317a6165a6631bbc5afb7918d70; ?>
<?php unset($__componentOriginalbf6b7317a6165a6631bbc5afb7918d70); ?>
<?php endif; ?>
                                    <?php else: ?>
                ...
                <div class="space-y-3 pt-6 border-t border-portal-border">
                    <div class="flex items-center justify-between text-sm">
                        <span class="text-portal-muted"><?php echo e(__('Commande passÃƒÂ©e')); ?></span>
                        <span class="font-mono text-white"><?php echo e($order->created_at->format('d/m/Y H:i')); ?></span>
                    </div>
                    <?php if($order->updated_at != $order->created_at): ?>
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-portal-muted"><?php echo e(__('DerniÃƒÂ¨re mise ÃƒÂ  jour')); ?></span>
                            <span class="font-mono text-white"><?php echo e($order->updated_at->format('d/m/Y H:i')); ?></span>
                        </div>
                    <?php endif; ?>
                    <?php if($order->requested_delivery_date): ?>
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-portal-muted"><?php echo e(__('Livraison demandÃƒÂ©e')); ?></span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user','data' => ['class' => 'w-4 h-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?> <?php echo e($order->user->first_name); ?> <?php echo e($order->user->last_name); ?>
                    ...
                    <div class="flex items-center gap-3 text-portal-muted">
                        <?php if (isset($component)) { $__componentOriginal5896e81091b45375b9e8fa46c99aa951 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5896e81091b45375b9e8fa46c99aa951 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.mail','data' => ['class' => 'w-4 h-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mail'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5896e81091b45375b9e8fa46c99aa951)): ?>
<?php $attributes = $__attributesOriginal5896e81091b45375b9e8fa46c99aa951; ?>
<?php unset($__attributesOriginal5896e81091b45375b9e8fa46c99aa951); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal5896e81091b45375b9e8fa46c99aa951)): ?>
<?php $component = $__componentOriginal5896e81091b45375b9e8fa46c99aa951; ?>
<?php unset($__componentOriginal5896e81091b45375b9e8fa46c99aa951); ?>
<?php endif; ?> <?php echo e($order->user->email); ?>

                    </div>
                    <?php if($order->user->phone): ?>
                    <div class="flex items-center gap-3 text-portal-muted">
                        <?php if (isset($component)) { $__componentOriginal4aa25b235056938313f77f0debe60c43 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4aa25b235056938313f77f0debe60c43 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.phone','data' => ['class' => 'w-4 h-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('phone'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4aa25b235056938313f77f0debe60c43)): ?>
<?php $attributes = $__attributesOriginal4aa25b235056938313f77f0debe60c43; ?>
<?php unset($__attributesOriginal4aa25b235056938313f77f0debe60c43); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal4aa25b235056938313f77f0debe60c43)): ?>
<?php $component = $__componentOriginal4aa25b235056938313f77f0debe60c43; ?>
<?php unset($__componentOriginal4aa25b235056938313f77f0debe60c43); ?>
    ...
    <div class="no-print bg-portal-sidebar border border-portal-border rounded-xl p-6 lg:p-8 mt-8">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="font-display font-bold text-xl flex items-center gap-3">
                        <?php if (isset($component)) { $__componentOriginal218e5ac7b293b40f2e14c7bfd24ab86e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal218e5ac7b293b40f2e14c7bfd24ab86e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.message-square','data' => ['class' => 'w-6 h-6 text-portal-accent']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('message-square'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal218e5ac7b293b40f2e14c7bfd24ab86e)): ?>
<?php $attributes = $__attributesOriginal218e5ac7b293b40f2e14c7bfd24ab86e; ?>
<?php unset($__attributesOriginal218e5ac7b293b40f2e14c7bfd24ab86e); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal218e5ac7b293b40f2e14c7bfd24ab86e)): ?>
<?php $component = $__componentOriginal218e5ac7b293b40f2e14c7bfd24ab86e; ?>
<?php unset($__componentOriginal218e5ac7b293b40f2e14c7bfd24ab86e); ?>
<?php endif; ?>
                ...
                <div class="space-y-6 mb-8 max-h-[500px] overflow-y-auto pr-4 custom-scrollbar">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="text-center py-12 border-2 border-dashed border-portal-border rounded-2xl">
                            <?php if (isset($component)) { $__componentOriginal4fd0a4fd05084fa63cd3a751c9b4c8db = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4fd0a4fd05084fa63cd3a751c9b4c8db = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.message-circle','data' => ['class' => 'w-12 h-12 text-portal-muted/30 mx-auto mb-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('message-circle'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4fd0a4fd05084fa63cd3a751c9b4c8db)): ?>
<?php $attributes = $__attributesOriginal4fd0a4fd05084fa63cd3a751c9b4c8db; ?>
<?php unset($__attributesOriginal4fd0a4fd05084fa63cd3a751c9b4c8db); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal4fd0a4fd05084fa63cd3a751c9b4c8db)): ?>
<?php $component = $__componentOriginal4fd0a4fd05084fa63cd3a751c9b4c8db; ?>
<?php unset($__componentOriginal4fd0a4fd05084fa63cd3a751c9b4c8db); ?>
<?php endif; ?>
                            <p class="text-portal-muted italic"><?php echo e(__('Aucune communication enregistrÃƒÂ©e pour cette commande.')); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
                    ...
                    <form action="<?php echo e(route('orders.comments.store', $order->id)); ?>" method="POST" class="space-y-4">
                        ...
                        <div class="relative">
                            <textarea 
                                ...
                                placeholder="<?php echo e(auth()->user()->role === 'admin' ? __('Ãƒâ€°crivez un message ou une note interne...') : __('Ãƒâ€°crivez un message pour l\'administration...')); ?>"
                                required
                            ></textarea>
                        </div>
                        <div class="flex items-center justify-between">
                            ...
                            <button type="submit" class="bg-portal-accent text-black font-black uppercase tracking-widest px-6 py-3 rounded-xl hover:bg-white transition-all flex items-center gap-2 text-xs shadow-lg">
                                <?php echo e(__('Envoyer')); ?> <?php if (isset($component)) { $__componentOriginal04d7c17ba0df3c42d2e2e370fbfba925 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal04d7c17ba0df3c42d2e2e370fbfba925 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.send','data' => ['class' => 'w-4 h-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('send'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal04d7c17ba0df3c42d2e2e370fbfba925)): ?>
<?php $attributes = $__attributesOriginal04d7c17ba0df3c42d2e2e370fbfba925; ?>
<?php unset($__attributesOriginal04d7c17ba0df3c42d2e2e370fbfba925); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal04d7c17ba0df3c42d2e2e370fbfba925)): ?>
<?php $component = $__componentOriginal04d7c17ba0df3c42d2e2e370fbfba925; ?>
<?php unset($__componentOriginal04d7c17ba0df3c42d2e2e370fbfba925); ?>
<?php endif; ?>
                            </button>
                        </div>
                    </form>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (printButton) {
            printButton.addEventListener('click', function(e) {
                ...
                // Open print view in new tab (no auto-print)
