        ...
        <table style="width: 100%; border: none; margin-bottom: 20px;">
            <tr>
                <td style="width: 50%; border: none; padding: 0;">
                    <?php if($logo = \App\Models\Setting::get('company_logo')): ?>
                        <img src="<?php echo e(Storage::url($logo)); ?>" style="height: 50px; width: auto; margin-bottom: 10px; object-fit: contain;">
                    <?php endif; ?>
                    <h1 class="text-2xl font-bold text-black mb-1 uppercase"><?php echo e(\App\Models\Setting::get('company_name', 'SARL GLOBAL ACCESSOIRES')); ?></h1>
                    <p class="text-xs text-black leading-tight"><?php echo e(\App\Models\Setting::get('company_description', 'Producteur de la marque MYFIX')); ?></p>
                    <p class="text-xs text-black leading-tight"><?php echo e(\App\Models\Setting::get('company_address', 'Zone Industrielle - Bordj Bou Arreridid, Algérie')); ?></p>
                    <p class="text-xs text-black leading-tight">Tél: <?php echo e(\App\Models\Setting::get('company_phone', '+213 550 00 00 00')); ?></p>
                    <p class="text-xs text-black leading-tight">Email: <?php echo e(\App\Models\Setting::get('company_email', 'commercial@myfix-dz.com')); ?></p>
                </td>
