...
<?php endif; ?>
            ...
            <p class="text-portal-muted text-xs uppercase tracking-widest mt-4"><?php echo e(__('Accès Sécurisé • Portail Partenaire')); ?></p>
        </div>
        ...
        <div class="bg-portal-sidebar border border-portal-border rounded-xl p-8 shadow-2xl">
            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-6">
                ...
                <?php endif; ?>
                <div>
                    <label class="block text-xs font-bold text-portal-muted uppercase tracking-wider mb-2"><?php echo e(__('Email Address')); ?></label>
                    <div class="relative">
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-5 h-5 absolute left-3 top-1/2 -translate-y-1/2 text-portal-muted']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                ...
                <div class="flex items-center justify-between mt-4">
                    <label class="flex items-center gap-2 cursor-pointer group">
                        ...
                        <span class="text-xs font-medium text-portal-muted group-hover:text-white transition-colors"><?php echo e(__('Remember Me')); ?></span>
                    </label>
                    <a href="#" class="text-xs font-medium text-portal-accent hover:text-white transition-colors"><?php echo e(__('Forgot Password?')); ?></a>
                </div>
                ...
                <button type="submit" class="w-full bg-portal-accent text-black font-bold py-3.5 rounded-lg hover:bg-white transition-colors flex items-center justify-center gap-2">
                    <?php echo e(__('Access Portal')); ?> <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        ...
        <p class="text-center text-xs text-portal-muted mt-8 opacity-50">&copy; <?php echo e(date('Y')); ?> SARL Global Accessoires. <?php echo e(__('All rights reserved.')); ?></p>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Bucket\Desktop\Commandes\placo-app\resources\views/auth/login.blade.php ENDPATH**/ ?>