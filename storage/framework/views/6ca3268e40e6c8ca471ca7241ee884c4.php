...
<?php $component->withAttributes([]); ?>
    <div class="max-w-7xl mx-auto px-6 py-12">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6 border-b border-white/5 pb-12">
            <div>
                <span
                    class="inline-block bg-portal-accent/10 text-portal-accent border border-portal-accent/20 px-3 py-1 rounded-full text-[0.65rem] font-bold uppercase tracking-widest mb-4"><?php echo e(__('Catalogue Officiel')); ?></span>
                <h1 class="text-4xl md:text-5xl font-display font-black tracking-tighter mb-4">
                    <?php echo e(__('Matériaux de Construction')); ?></h1>
                <p class="text-slate-400 text-lg max-w-2xl">
                    <?php echo e(__('Explorez notre inventaire complet de produits certifiés pour vos projets.')); ?></p>
            </div>

            <div class="flex items-center gap-4">
                <div class="text-right hidden md:block">
                    <div class="text-xs font-bold text-slate-500 uppercase tracking-widest"><?php echo e(__('Mise à jour')); ?></div>
                    <div class="text-white font-mono text-sm"><?php echo e(date('d M Y')); ?></div>
                </div>
            </div>
        </div>
            ...
            async addToRequisition(productId, quantity = 1) {
                try {
                    ...
                    if (data.success) {
                        ...
                        window.showToast(data.message || <?php echo \Illuminate\Support\Js::from(__('Produit ajouté !'))->toHtml() ?>, 'success');
                    } else {
                        window.showToast(data.message || <?php echo \Illuminate\Support\Js::from(__("Erreur lors de l'ajout"))->toHtml() ?>, 'error');
                    }
                } catch (error) {
                    console.error('Failed to add to commande:', error);
                    window.showToast(<?php echo \Illuminate\Support\Js::from(__('Une erreur est survenue.'))->toHtml() ?>, 'error');
                }
            },
...
<?php endif; ?>
                    <input type="text" x-model.debounce.500ms="searchQuery" @input="watchSearch()"
                        placeholder="<?php echo e(__('Rechercher...')); ?>"
                ...
                <div class="flex gap-2 overflow-x-auto pb-1 no-scrollbar">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button @click="watchCategory('<?php echo e($category->slug); ?>')"
                            :class="selectedCategory === '<?php echo e($category->slug); ?>' ? 'bg-portal-accent text-black font-bold' :
                                'bg-white/5 border border-white/10 text-slate-400'"
                            class="whitespace-nowrap px-4 py-2 rounded-full text-xs font-semibold transition-all">
                ...
                <div class="p-6 bg-[#141415] border border-white/5 rounded-2xl">
                    ...
                    <div class="space-y-1">
                        <button @click="watchCategory('all')"
                            ...
                            <?php echo e(__('Tout le catalogue')); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 rtl:rotate-180 transition-transform group-hover:translate-x-1','x-bind:class' => 'selectedCategory === \'all\' ? \'opacity-100\' : \'opacity-0\'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button @click="watchCategory('<?php echo e($category->slug); ?>')"
                                :class="selectedCategory === '<?php echo e($category->slug); ?>' ?
                                    'bg-portal-accent text-black shadow-[0_0_20px_rgba(250,204,21,0.2)]' :
                                    'text-slate-400 hover:bg-white/5 hover:text-white'"
                                class="w-full text-start px-4 py-3 rounded-xl text-sm font-bold transition-all flex items-center justify-between group">
                                <?php echo e($category->name); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 rtl:rotate-180 transition-transform group-hover:translate-x-1','x-bind:class' => 'selectedCategory === \''.e($category->slug).'\' ? \'opacity-100\' : \'opacity-0\'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                    ...
                    <p class="text-xs text-slate-400 mb-4">
                        <?php echo e(__('Besoin d\'un devis spécifique ou d\'un conseil technique ?')); ?></p>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-5 h-5 text-slate-400 group-focus-within:text-portal-accent transition-colors']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                        <input type="text" x-model.debounce.300ms="searchQuery" @input="watchSearch()"
                            ...
                            placeholder="<?php echo e(__('Rechercher par référence, nom ou spécification...')); ?>"
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6 text-slate-500 opacity-50']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                                    ...
                                    <template x-if="isAuthenticated">
                                        <div class="text-sm font-mono font-bold text-slate-300"
                                            x-text="Number(product.price).toFixed(2) + ' <?php echo e(__('DA')); ?>'"></div>
                                    </template>
                                </div>
                            </template>
                        </div>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4','x-bind:class' => 'product.is_favorite ? \'fill-current\' : \'\'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-20 h-20 stroke-1 mb-2 opacity-50']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                        <span class="text-xs font-medium"><?php echo e(__('Image non disponible')); ?></span>
                                    </div>
                                </template>
                            </div>
                                ...
                                <template x-if="isAuthenticated">
                                    <div class="flex items-end justify-between mb-3 pb-3 border-t border-white/5">
                                        <div>
                                            ...
                                            <span class="text-sm text-slate-500 ml-1"><?php echo e(__('DA')); ?></span>
                                        </div>
                                        <span class="text-[0.6rem] font-semibold text-slate-500 uppercase tracking-wider"><?php echo e(__('HT')); ?></span>
                                    </div>
                                </template>
                                <template x-if="!isAuthenticated">
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 text-slate-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                        <span class="text-xs font-medium text-slate-500"><?php echo e(__('Connectez-vous pour les tarifs')); ?></span>
                                    </div>
                                </template>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 animate-spin text-portal-accent']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                    ...
                    <template x-if="!loading && !hasMore && products.length > 0">
                        <div class="text-slate-500 font-bold text-[0.6rem] uppercase tracking-widest opacity-50">
                            <?php echo e(__('Fin du catalogue technique')); ?>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-search-x'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-12 h-12 mx-auto mb-4 text-slate-600']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                            <?php echo e(__('Aucun produit correspondant.')); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6','x-bind:class' => 'selectedProduct && selectedProduct.is_favorite ? \'fill-current\' : \'\'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-32 h-32 text-slate-300 stroke-1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
                        ...
                        <div class="lg:w-1/2 p-8 lg:p-12 overflow-y-auto bg-[#141415]" x-data="{
                            ...
                            <div class="flex items-center gap-6 mb-8 py-6 border-y border-white/5">
                                <div>
                                    <div class="text-[0.6rem] font-bold text-slate-500 uppercase tracking-wider mb-1">
                                        <?php echo e(__('Tarif B2B Unitaire')); ?></div>
                                    <template x-if="isAuthenticated">
                                        <div
                                    ...
                                    <template x-if="!isAuthenticated">
                                        <div class="text-lg font-bold text-slate-500 italic">
                                            <?php echo e(__('Tarification Réservée')); ?></div>
                                    </template>
                                </div>

                                <div x-show="selectedProduct && selectedProduct.weight_kg">
                                    <div class="text-[0.6rem] font-bold text-slate-500 uppercase tracking-wider mb-1">
                                        <?php echo e(__('Poids/Unité')); ?></div>
                            ...
                            <div class="space-y-6">
                                <h4 class="text-sm font-bold text-slate-400 uppercase tracking-widest">
                                    <?php echo e(__('Approvisionnement')); ?></h4>
                                ...
                                <form :action="'/commande/add/' + (selectedProduct ? selectedProduct.id : '')"
                                    ...
                                    <div>
                                        <label
                                            class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-3"><?php echo e(__('Calculateur de Volume')); ?></label>
...
<?php endif; ?>
                                            ...
                                            <div class="flex-1">
                                                <div class="text-sm font-bold text-blue-400 mb-1">
                                                    <?php echo e(__('Optimisez votre logistique')); ?></div>
                                                <p class="text-xs text-blue-300 leading-relaxed mb-3">
                                                    <?php echo e(__('Ce produit est livré en paquets de')); ?> <span
                                                        class="font-bold text-white" x-text="piecesPerBundle"></span>.
                                                    <?php echo e(__('Commandez')); ?> <span class="font-bold text-white"
                                                        x-text="suggestedQuantity"></span>
                                                    <?php echo e(__('pièces pour recevoir des paquets complets.')); ?>
...
<?php endif; ?>
                                            ...
                                            <p class="text-xs text-green-300 font-bold">
                                                <?php echo e(__('Parfait ! Votre commande correspond à des paquets complets.')); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6 group-hover:scale-110 transition-transform']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                        <?php echo e(__('Ajouter à la Réquisition')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Bucket\Desktop\Commandes\placo-app\resources\views/products/index.blade.php ENDPATH**/ ?>