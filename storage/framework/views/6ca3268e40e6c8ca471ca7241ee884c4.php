...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-5 h-5','x-bind:class' => 'product.is_favorite ? \'fill-current\' : \'\'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-16 h-16 text-slate-300 stroke-1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
                                        ...
                                        <template x-if="isAuthenticated">
                                            <div class="flex items-end justify-between mb-2">
                                                ...
                                                <div class="text-xs text-slate-500 font-bold uppercase tracking-wider">
                                                    <?php echo e(__('HT')); ?></div>
                                            </div>
                                        </template>
                                        <template x-if="!isAuthenticated">
                                            <div class="text-sm font-medium text-slate-500 italic mb-2">
                                                <?php echo e(__('Connectez-vous pour voir les tarifs')); ?></div>
                                        </template>
...
<?php endif; ?>
                                                    ...
                                                    <button @click="addToRequisition(product.id, localQty)"
                                                        ...
                                                        <?php echo e(__('Sélectionner')); ?> <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                            ...
                                            <template x-if="!isAuthenticated">
                                                <a href="<?php echo e(route('login')); ?>"
                                                    ...
                                                    <?php echo e(__('Accès Client Requis')); ?>
