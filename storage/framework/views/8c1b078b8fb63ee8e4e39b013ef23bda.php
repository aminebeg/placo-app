...
<?php endif; ?>
    ...
    <?php else: ?>
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8" x-data="{
            items: <?php echo e(json_encode($requisition)); ?>,
...
<?php endif; ?>
            ...
            <!-- Sidebar Summary -->
            <form action="<?php echo e(route('requisition.finalize')); ?>" method="POST" class="xl:col-span-1 space-y-6">
                <?php echo csrf_field(); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 text-blue-400 shrink-0 mt-0.5']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                                <p class="text-[0.7rem] text-slate-400 leading-relaxed">
                                    <?php echo e(__('Un conseiller commercial MYFIX vous contactera par téléphone pour confirmer les détails logistiques et valider votre approvisionnement.')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Bucket\Desktop\Commandes\placo-app\resources\views/requisition/index.blade.php ENDPATH**/ ?>