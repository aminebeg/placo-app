...
<head>
    ...
    <title><?php echo e(config('app.name', 'Global Accessoires')); ?></title>
...
<?php endif; ?>
                    ...
                    <div class="flex flex-col leading-tight">
                        <span class="text-white text-base font-display font-black tracking-tight uppercase"><?php echo e(__('GLOBAL')); ?></span>
                        <span class="text-portal-accent text-[0.55rem] font-bold uppercase tracking-[0.2em]"><?php echo e(__('Accessoires')); ?></span>
                    </div>
                </div>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                        <?php echo e(__('Catalogue Technique')); ?>

                    </a>

                    <a href="<?php echo e(route('commande.index')); ?>" @click="sidebarOpen = false" class="flex items-center gap-3 px-4 py-3.5 rounded-xl font-semibold text-sm transition-all <?php echo e(request()->routeIs('commande.*') ? 'bg-portal-accent/10 text-portal-accent' : 'text-portal-muted hover:bg-white/5 hover:text-white'); ?>">
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                        <?php echo e(__('Ma Sélection')); ?>

                        <?php if(count(session('commande', [])) > 0): ?>
                            <span class="ms-auto bg-portal-accent text-black text-[0.6rem] font-extrabold px-1.5 py-0.5 rounded"><?php echo e(count(session('commande', []))); ?></span>
                        <?php endif; ?>
                    </a>

                    <a href="<?php echo e(route('favorites.index')); ?>" @click="sidebarOpen = false" class="flex items-center gap-3 px-4 py-3.5 rounded-xl font-semibold text-sm transition-all <?php echo e(request()->routeIs('favorites.*') ? 'bg-portal-accent/10 text-portal-accent' : 'text-portal-muted hover:bg-white/5 hover:text-white'); ?>">
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-5 h-5 me-3 '.e(request()->routeIs('favorites.*') ? 'fill-current' : '').'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                        ...
                        <a href="<?php echo e(route('orders.index')); ?>" @click="sidebarOpen = false" class="flex items-center gap-3 px-4 py-3.5 rounded-xl font-semibold text-sm transition-all <?php echo e(request()->routeIs('orders.*') ? 'bg-portal-accent/10 text-portal-accent' : 'text-portal-muted hover:bg-white/5 hover:text-white'); ?>">
                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        ...
                        <a href="<?php echo e(route('profile.edit')); ?>" @click="sidebarOpen = false" class="flex items-center gap-3 px-4 py-3.5 rounded-xl font-semibold text-sm transition-all <?php echo e(request()->routeIs('profile.*') ? 'bg-portal-accent/10 text-portal-accent' : 'text-portal-muted hover:bg-white/5 hover:text-white'); ?>">
                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                    ...
                    <?php if(auth()->user()->role === 'admin' || auth()->user()->role === 'agent'): ?>
                        ...
                        <a href="<?php echo e(route('admin.dashboard', ['tab' => 'new_orders'])); ?>" @click="sidebarOpen = false" class="flex items-center gap-3 px-4 py-3.5 rounded-xl font-semibold text-sm transition-all <?php echo e(request()->fullUrlIs(route('admin.dashboard', ['tab' => 'new_orders'])) ? 'bg-portal-accent/10 text-portal-accent' : 'text-portal-muted hover:bg-white/5 hover:text-white'); ?>">
                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        ...
                        <a href="<?php echo e(route('admin.orders.create')); ?>" @click="sidebarOpen = false" class="flex items-center gap-3 px-4 py-3.5 rounded-xl font-semibold text-sm transition-all <?php echo e(request()->routeIs('admin.orders.create') ? 'bg-portal-accent/10 text-portal-accent' : 'text-portal-muted hover:bg-white/5 hover:text-white'); ?>">
                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-plus-circle'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-user-circle'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
<?php endif; ?>
                        ...
                        <a href="<?php echo e(route('admin.dashboard', ['tab' => 'products'])); ?>" @click="sidebarOpen = false" class="flex items-center gap-3 px-4 py-3.5 rounded-xl font-semibold text-sm transition-all <?php echo e(request()->fullUrlIs(route('admin.dashboard', ['tab' => 'products'])) ? 'bg-portal-accent/10 text-portal-accent' : 'text-portal-muted hover:bg-white/5 hover:text-white'); ?>">
                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-package'); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                            <?php echo e(__('Annuaire')); ?>

                        </a>

                        <a href="<?php echo e(route('admin.settings.index')); ?>" @click="sidebarOpen = false" class="flex items-center gap-3 px-4 py-3.5 rounded-xl font-semibold text-sm transition-all <?php echo e(request()->routeIs('admin.settings.*') ? 'bg-portal-accent/10 text-portal-accent' : 'text-portal-muted hover:bg-white/5 hover:text-white'); ?>">
                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <div class="flex items-center gap-3 mb-5">
                        <div class="w-10 h-10 shrink-0 rounded-xl bg-gradient-to-br from-[#2c2c2e] to-[#1c1c1e] border border-portal-border flex items-center justify-center font-bold text-portal-accent">
                            <?php echo e(substr(auth()->user()->first_name ?? 'U', 0, 1)); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 me-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                ...
                <?php else: ?>
                    <div class="flex flex-col gap-3">
                        <a href="<?php echo e(route('login')); ?>" class="w-full p-3 bg-portal-accent text-black rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-portal-accent/90 transition-all">
                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="w-full p-3 bg-white/5 border border-portal-border text-white rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-white/10 transition-all">
                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 text-portal-muted me-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                ...
                <div class="flex items-center gap-3 lg:gap-6">
                    <a href="<?php echo e(route('favorites.index')); ?>" class="relative p-2 text-portal-muted hover:text-white transition-all group" title="<?php echo e(__('Mes Favoris')); ?>">
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-heart'); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-5 h-5 group-hover:scale-110 transition-transform group-hover:text-red-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                    ...
                    <a href="<?php echo e(route('commande.index')); ?>" class="relative p-2 text-portal-muted hover:text-white transition-all group" title="<?php echo e(__('Ma Sélection')); ?>">
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-list-checks'); ?>
...
<?php endif; ?>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="text-[0.65rem] lg:text-xs font-bold text-portal-muted hover:text-white transition-colors flex items-center gap-2 uppercase">
                            <?php echo e(strtoupper(app()->getLocale())); ?> <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute end-0 mt-2 w-32 bg-portal-sidebar border border-portal-border rounded-lg shadow-xl overflow-hidden py-1 z-50" x-cloak>
                            <a href="<?php echo e(route('language.switch', 'fr')); ?>" class="block px-4 py-2 text-sm text-portal-muted hover:text-white hover:bg-white/5">Français</a>
                            <a href="<?php echo e(route('language.switch', 'ar')); ?>" class="block px-4 py-2 text-sm text-portal-muted hover:text-white hover:bg-white/5 text-end">العربية</a>
                            <a href="<?php echo e(route('language.switch', 'en')); ?>" class="block px-4 py-2 text-sm text-portal-muted hover:text-white hover:bg-white/5">English</a>
                        </div>
                    </div>
...
<?php endif; ?>
                    ...
                    <span class="hidden lg:block text-[0.6rem] font-bold text-portal-muted uppercase tracking-wider"><?php echo e(now()->format('d F Y')); ?></span>
                </div>
            </header>
        ...
        >
            <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('dashboard')); ?>" class="flex flex-col items-center gap-1 <?php echo e(request()->routeIs('dashboard') ? 'text-portal-accent' : 'text-portal-muted'); ?>">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-layout-dashboard'); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                <span class="text-[0.55rem] font-bold uppercase"><?php echo e(__('Home')); ?></span>
            </a>
            <?php endif; ?>
            
            <a href="<?php echo e(route('products.index')); ?>" class="flex flex-col items-center gap-1 <?php echo e(request()->routeIs('products.*') ? 'text-portal-accent' : 'text-portal-muted'); ?>">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-package'); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                <span class="text-[0.55rem] font-bold uppercase"><?php echo e(__('Catalogue')); ?></span>
            </a>
            <a href="<?php echo e(route('commande.index')); ?>" class="relative flex flex-col items-center gap-1 <?php echo e(request()->routeIs('commande.*') ? 'text-portal-accent' : 'text-portal-muted'); ?>">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-list-checks'); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                <span class="text-[0.55rem] font-bold uppercase"><?php echo e(__('Sélection')); ?></span>
                <template x-if="commandeCount > 0">
            ...
            <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('orders.index')); ?>" class="flex flex-col items-center gap-1 <?php echo e(request()->routeIs('orders.*') ? 'text-portal-accent' : 'text-portal-muted'); ?>">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-file-text'); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                <span class="text-[0.55rem] font-bold uppercase"><?php echo e(__('Commandes')); ?></span>
            </a>
            <?php endif; ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                <span class="text-[0.55rem] font-bold uppercase"><?php echo e(__('Menu')); ?></span>
            </button>
        </nav>
        ...
        <div 
            ...
            <?php echo $__env->yieldSection(); ?>-toast.window="showToast($event.detail.message, $event.detail.type)"
            x-show="show"
...
<?php endif; ?>
                ...
                <div>
                    <div class="text-[0.6rem] font-extrabold text-portal-muted uppercase tracking-[0.2em] mb-0.5" x-text="type === 'success' ? '<?php echo e(__('Succès')); ?>' : '<?php echo e(__('Attention')); ?>'"></div>
...
<?php /**PATH C:\Users\Bucket\Desktop\Commandes\placo-app\resources\views/components/app-layout.blade.php ENDPATH**/ ?>