                                    ...
                                    <tr class="hover:bg-white/5 transition-all cursor-pointer group" onclick="window.location='<?php echo e(route('orders.show', $order->id)); ?>'">
                                        ...
                                        <td class="px-6 py-4">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold uppercase tracking-wider
                                                ...
                                                <?php echo e($order->status === 'processing' ? 'bg-blue-500/10 text-blue-500' : ''); ?>
...
<?php endif; ?>
                ...
                <div class="bg-portal-sidebar border border-portal-border rounded-xl p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin')): ?>
                        <form action="<?php echo e(route('admin.logs.clear')); ?>" method="POST" onsubmit="return confirm('<?php echo e(__('Effacer tout l\'historique d\'activité ?')); ?>');">
                            <?php echo csrf_field(); ?>
        ...
        <div x-show="activeTab === 'products'" 
            ...
            <div class="bg-portal-sidebar border border-portal-border rounded-xl flex flex-col">
                <div class="p-6 border-b border-portal-border flex items-center justify-between">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin')): ?>
                    <a href="<?php echo e(route('products.create')); ?>" class="bg-portal-accent text-black px-4 py-2 rounded-lg font-bold text-sm hover:bg-white transition-colors flex items-center gap-2">
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-plus'); ?>
                    ...
                    <table class="w-full text-start whitespace-nowrap">
                        <thead class="bg-white/2 text-xs font-bold text-portal-muted uppercase tracking-wider">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-start"><?php echo e(__('État Stock')); ?></th>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin')): ?>
...
<?php endif; ?>
                                    ...
                                    <td class="px-4 md:px-6 py-4 text-end">
                                        <div class="flex justify-end gap-2">
                                            <a href="<?php echo e(route('products.edit', $product->id)); ?>" class="p-2.5 md:p-2 hover:bg-white/10 rounded-lg text-portal-muted hover:text-white transition-colors inline-flex items-center justify-center min-h-[44px] min-w-[44px] md:min-h-0 md:min-w-0">
                                                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                            ...
                                            <form action="<?php echo e(route('products.destroy', $product->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(__('Are you sure you want to delete this asset?')); ?>');" class="inline-block">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                ...
                <div x-show="selectedOrders.length > 0" 
                    ...
                    <form action="<?php echo e(route('admin.orders.bulkUpdate')); ?>" method="POST" class="flex items-center gap-3">
                        ...
                        <select name="status" class="bg-black border border-white/20 text-white text-xs font-bold uppercase rounded-xl px-4 py-2 focus:ring-portal-accent focus:border-portal-accent outline-none">
                            ...
                            <option value="processing"><?php echo e(__('Process Selection')); ?></option>
                            <option value="delivered"><?php echo e(__('Mark Delivered')); ?></option>
                            <option value="cancelled"><?php echo e(__('Cancel Selection')); ?></option>
                        </select>
...
<?php endif; ?> <?php echo e(__('Export CSV')); ?>
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <select x-model="statusFilter" class="bg-white/5 border border-portal-border text-white text-sm font-bold rounded-lg px-4 py-2 focus:ring-portal-accent focus:border-portal-accent">
                            ...
                            <option value="processing"><?php echo e(__('En traitement')); ?></option>
                            <option value="delivered"><?php echo e(__('Livrées')); ?></option>
                            <option value="cancelled"><?php echo e(__('Annulées')); ?></option>
                        </select>
                    ...
                    <table class="w-full text-start">
                        <thead class="bg-white/2 text-xs font-bold text-portal-muted uppercase tracking-wider">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-start"><?php echo e(__('Référence Projet')); ?></th>
...
<?php $component = $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?> <?php echo e(__('Approve')); ?>
...
<?php $component = $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?> <?php echo e(__('Deliver')); ?>
                                                ...
                                                <template x-if="order.status !== 'delivered' && order.status !== 'cancelled'">
                                                    <form :action="`/admin/orders/${order.id}/status`" method="POST">
                                                        ...
                                                        <button type="submit" class="p-2 hover:bg-red-500/10 rounded-lg text-portal-muted hover:text-red-500 transition-colors" :title="'<?php echo e(__('Cancel')); ?>'">
                                                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
