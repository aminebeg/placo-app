...
<?php endif; ?> <?php echo e(__('Retour aux Commandes')); ?>
                ...
                <p class="text-portal-muted mt-1"><?php echo e(__('Création manuelle de commande pour un client.')); ?></p>
            </div>
...
<?php endif; ?>
        ...
        <form id="order-form" action="<?php echo e(route('admin.orders.store')); ?>" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <?php echo csrf_field(); ?>
                ...
                <div class="bg-portal-sidebar/50 backdrop-blur-sm border border-portal-border rounded-xl overflow-hidden">
                    <div class="px-6 py-4 border-b border-portal-border bg-white/5 flex items-center justify-between">
                        <h2 class="font-bold text-lg flex items-center gap-2 text-white">
                            <span class="p-1.5 rounded-lg bg-blue-500/10 text-blue-400"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?></span>
                    ...
                    <div class="px-6 pt-6 -mb-2 relative z-20">
                        <label class="block text-xs font-bold text-portal-muted uppercase tracking-wider mb-2"><?php echo e(__('Rechercher un client existant')); ?></label>
                        <div class="relative">
                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-portal-sidebar/50 backdrop-blur-sm border border-portal-border rounded-xl overflow-hidden p-6 space-y-6">
                    <div class="relative">
                        <label class="block text-xs font-bold text-portal-muted uppercase tracking-wider mb-2"><?php echo e(__('Statut Initial')); ?></label>
                        <select name="status" class="w-full bg-black/40 border border-portal-border text-white rounded-lg pl-4 pr-10 py-2.5 focus:ring-1 focus:ring-portal-accent focus:border-portal-accent appearance-none transition-colors">
                            <option value="pending" class="bg-[#141415]" <?php echo e(old('status') == 'pending' ? 'selected' : ''); ?>><?php echo e(__('En attente (Pending)')); ?></option>
                            <option value="confirmed" class="bg-[#141415]" <?php echo e(old('status') == 'confirmed' ? 'selected' : (!old('status') ? 'selected' : '')); ?>><?php echo e(__('Confirmé (Confirmed)')); ?></option>
                            <option value="in_delivery" class="bg-[#141415]" <?php echo e(old('status') == 'in_delivery' ? 'selected' : ''); ?>><?php echo e(__('En Livraison (In Delivery)')); ?></option>
                            <option value="delivered" class="bg-[#141415]" <?php echo e(old('status') == 'delivered' ? 'selected' : ''); ?>><?php echo e(__('Livré (Delivered)')); ?></option>
                        </select>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="requested_delivery_date" value="<?php echo e(old('requested_delivery_date', date('Y-m-d', strtotime('+3 days')))); ?>" class="w-full bg-black/40 border border-portal-border text-white rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-portal-accent/50 focus:border-portal-accent transition-colors" min="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                </div>
                ...
                <div class="bg-portal-sidebar/50 backdrop-blur-sm border border-portal-border rounded-xl overflow-hidden p-6">
                    ...
                    <textarea name="delivery_address" rows="4" class="w-full bg-black/40 border border-portal-border text-white rounded-lg px-4 py-3 focus:ring-2 focus:ring-portal-accent/50 focus:border-portal-accent transition-colors resize-none"><?php echo e(old('delivery_address')); ?></textarea>
                </div>

                <!-- Notes -->
                <div class="bg-portal-sidebar/50 backdrop-blur-sm border border-portal-border rounded-xl overflow-hidden p-6">
                    <label class="block text-xs font-bold text-portal-muted uppercase tracking-wider mb-2"><?php echo e(__('Notes Internes')); ?></label>
                    <textarea name="notes" rows="3" class="w-full bg-black/40 border border-portal-border text-white rounded-lg px-4 py-3 focus:ring-2 focus:ring-portal-accent/50 focus:border-portal-accent transition-colors resize-none" placeholder="Instructions..."><?php echo e(old('notes')); ?></textarea>
                </div>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('orderForm', () => ({
                items: <?php echo json_encode(old('items', [['product_id' => '', 'quantity' => 1]])) ?>,
...
<?php endif; ?>
<?php /**PATH C:\Users\Bucket\Desktop\Commandes\placo-app\resources\views/admin/orders/create.blade.php ENDPATH**/ ?>