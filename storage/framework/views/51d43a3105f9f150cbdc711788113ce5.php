...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-4xl">
        <div class="bg-portal-sidebar border border-portal-border rounded-xl p-8">
            <form method="POST" action="<?php echo e(route('admin.products.store')); ?>" enctype="multipart/form-data" class="space-y-8">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <select name="category_id" class="w-full bg-white/5 border border-portal-border rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-portal-accent/50 focus:border-portal-accent transition-all text-sm font-medium cursor-pointer">
                                <?php $__currentLoopData = \App\Models\Category::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category->id); ?>" class="bg-portal-sidebar"><?php echo e($category->name_en); ?></option>
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="status" class="w-full bg-white/5 border border-portal-border rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-portal-accent/50 focus:border-portal-accent transition-all text-sm font-medium cursor-pointer">
                            <option value="active" class="bg-portal-sidebar"><?php echo e(__('Actif - Visible pour les clients')); ?></option>
                            <option value="draft" class="bg-portal-sidebar"><?php echo e(__('Brouillon - En cours de préparation')); ?></option>
                            <option value="archived" class="bg-portal-sidebar"><?php echo e(__('Archivé - Masqué du catalogue')); ?></option>
                        </select>
                    </div>
                </div>
...
<?php endif; ?>
                    ...
                    <div class="space-y-6">
                        <div class="space-y-2">
                            ...
                            <textarea name="description_en" rows="4" class="w-full bg-white/5 border border-portal-border rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-portal-accent/50 focus:border-portal-accent transition-all placeholder-portal-muted text-sm"><?php echo e(old('description_en')); ?></textarea>
                        </div>
                        <div class="space-y-2">
                            <label class="block text-xs font-bold text-portal-muted uppercase tracking-wider"><?php echo e(__('Description (FR)')); ?></label>
                            <textarea name="description_fr" rows="4" class="w-full bg-white/5 border border-portal-border rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-portal-accent/50 focus:border-portal-accent transition-all placeholder-portal-muted text-sm"><?php echo e(old('description_fr')); ?></textarea>
                        </div>
                        <div class="space-y-2">
                            <label class="block text-xs font-bold text-portal-muted uppercase tracking-wider"><?php echo e(__('Description (AR)')); ?></label>
                            <textarea name="description_ar" rows="4" dir="rtl" class="w-full bg-white/5 border border-portal-border rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-portal-accent/50 focus:border-portal-accent transition-all placeholder-portal-muted text-sm"><?php echo e(old('description_ar')); ?></textarea>
                        </div>
                    </div>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-video'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                        <?php echo e(__('Video Content')); ?>

                    </h3>
                    
                    <div class="space-y-2">
                        <label class="block text-xs font-bold text-portal-muted uppercase tracking-wider"><?php echo e(__('How-to-Use Video URL')); ?></label>
                        <input 
                            type="url" 
                        ...
                        >
                        <p class="text-xs text-slate-500"><?php echo e(__('Optional. Enter a YouTube video URL.')); ?></p>
                    </div>
                </div>
...
<?php $component = $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?> <?php echo e(__('Save Asset')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Bucket\Desktop\Commandes\placo-app\resources\views\products\create.blade.php ENDPATH**/ ?>