        ...
        <div class="bg-portal-sidebar border border-portal-border rounded-xl p-6 lg:p-8">
            <form action="<?php echo e(route('profile.update')); ?>" method="POST" class="space-y-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-white mb-4"><?php echo e(__('Informations Personnelles')); ?></h3>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" required class="w-full bg-black border border-portal-border rounded-xl px-4 py-3 text-sm text-white focus:ring-2 focus:ring-portal-accent/50 focus:border-portal-accent transition-all">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="border-t border-portal-border pt-6">
                        <h3 class="text-lg font-bold text-white mb-4"><?php echo e(__('Informations Professionnelles')); ?></h3>
                        <div class="grid md:grid-cols-2 gap-4">
                            <div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="tel" name="phone" value="<?php echo e(old('phone', $user->phone)); ?>" required class="w-full bg-black border border-portal-border rounded-xl px-4 py-3 text-sm text-white focus:ring-2 focus:ring-portal-accent/50 focus:border-portal-accent transition-all">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="border-t border-portal-border pt-6">
                        <h3 class="text-lg font-bold text-white mb-4"><?php echo e(__('Sécurité (Laisser vide pour ne pas changer)')); ?></h3>
                        <div class="grid md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="password" name="password" autocomplete="new-password" class="w-full bg-black border border-portal-border rounded-xl px-4 py-3 text-sm text-white focus:ring-2 focus:ring-portal-accent/50 focus:border-portal-accent transition-all">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="password" name="password_confirmation" autocomplete="new-password" class="w-full bg-black border border-portal-border rounded-xl px-4 py-3 text-sm text-white focus:ring-2 focus:ring-portal-accent/50 focus:border-portal-accent transition-all">
                            </div>
                        </div>
                    </div>
                </div>

                <div class="flex flex-wrap items-center gap-3 pt-6 border-t border-portal-border">
